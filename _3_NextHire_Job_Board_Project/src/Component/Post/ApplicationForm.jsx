                ...
                <div className="fixed inset-0 flex items-center justify-center z-50 bg-gray-900 bg-opacity-50">
                    ...
                    <motion.div
                        ...
                        <form className="space-y-4" onSubmit={handleSubmit}>
                            ...
                            <div className="flex flex-col">
                                ...
                                <textarea required id="description" className="border border-gray-300 rounded-md p-2" rows="4"
                                    placeholder="Tell us about yourself or describe your experience"
                                ></textarea>
                            </div>
                        ...
                        <button
                            ...
                            className="mt-4 bg-gray-500 text-white py-2 px-4 rounded-lg hover:bg-gray-600 transition duration-200"
                        >
                            Close
                        </button>
                    </motion.div>
